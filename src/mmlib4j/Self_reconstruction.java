...
public class Self_reconstruction implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		GrayScaleImage imgOut = rec.selfReconstruction(g);
		ImagePlus imgPlus = new ImagePlus("Self-reconstruction", ImageJAdapter.toByteProcessor(imgOut));
		imgPlus.show();
	 ...
	 boolean showDialog() { 
         ...
         gd.addMessage("This plug-in calculates self-reconstruction");
